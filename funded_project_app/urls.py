...
urlpatterns = [
    ...
    path('projects/', views.get_all_funded_projects, name='get_all_funded_projects'),
    ...
    path('accept/<int:pk>/', views.accept_funded_project, name='accept_funded_project'),
    path('reject/<int:pk>/', views.reject_funded_project, name='reject_funded_project'),
]
